...
<head>
    ...
    <title>GITA - ABOUT</title>

    <meta name="author" content="MagicTINTIN">
    <meta name="description" content="ABOUT Copy Paste Over Internet tool">

    <link rel="icon" type="image/x-icon" href="images/favicon.png">

    <meta property="og:type" content="website" />
    <meta property="og:title" content="About GITA">
    <meta property="og:description" content="About Copy Paste Over Internet tool">
...
<body>
    ...
    <h1>GITA</h1>
    <main>
        <section id="voidSection"><br><br><br><br><br></section>
        <section id="termsSection">
            <h4 id="termsH4">Terms & Conditions of Use</h4>
            <article class="terms aboutArticle" id="enTerms">
            ...
            <article class="terms aboutArticle" id="frTerms">
                <h5>1. Introduction</h5>
        ...
        <section id="policySection">
            ...
            <article class="terms aboutArticle" id="enPrivacy">
                <h5>Data Collection and Use</h5>
                The COPI website and extension allow users to copy and paste text between different devices. The copied
                data is
            ...
            <article class="terms aboutArticle" id="frPrivacy">
                <h5>Collecte et utilisation des données</h5>
                Le site web et l'extension COPI permettent aux utilisateurs de copier et coller du texte entre
        ...
        <p id="footerLinkContainer"><a tabindex="-1" href="https://gita.0xy.fr"
                class="bottomLink">gita.0xy.fr</a>
        </p>
    </main>
    <script src="./scripts/memory.js"></script>
    <script src="./scripts/aboutsettings.js"></script>
</body>
